    ...
    <div className="container-fluid row" style={{padding:'100px 20px'}}>
        <div className="col col-6 col-sm-3 ">
            ...
            <ul className="mt-5" style={{listStyleType:'none'}}>
                ...
                <li><a>Thiết bị đeo</a></li>
                <li><a>Tai nghe và loa</a></li>
                <li><a>Màn hình </a></li>
                <li><a>Router</a></li>
                <li><a>Phụ kiện</a></li>
            </ul>
        </div>
        ...
        <div className="col col-6 col-sm-3  ">
            ...
            <ul className="mt-5" style={{listStyleType:'none'}}>
                ...
                <li><a>HUAWEI ID</a></li>
                <li><a>HUAWEI Mobile Cloud</a></li>
                <li><a>HUAWEI Trình duyệt</a></li>
                <li><a>HUAWEI Sức khỏe</a></li>
                <li><a>HUAWEI Assistant·TODAY</a></li>
                <li><a>Petal Search</a></li>
                <li><a>Petal Maps</a></li>
            </ul>
        </div>
        ...
        <div className="col col-6 col-sm-3">
            ...
            <ul className="mt-5" style={{listStyleType:'none'}}>
                ...
                <li><a>Tiến độ sửa chữa</a></li>
                <li><a>Tuyên bố Quyền riêng tư</a></li>
                <li><a>Chính sách bảo hành</a></li>
            </ul>
        </div>
        ...
        <div className="col col-6 col-sm-3">
            ...
            <ul className="mt-5" style={{listStyleType:'none'}}>
                ...
                <li><a>Vận chuyển HUAWEI</a></li>
                <li><a>Tập Đoàn HUAWEI</a></li>
                <li><a>Tham gia với chúng tôi</a></li>
                <li><a>Liên lạc với chúng tôi</a></li>
            </ul>
        </div>
    </div>
    <hr/>
